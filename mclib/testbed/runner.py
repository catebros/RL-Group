...
from ..training.loops import (train_tabular, evaluate_tabular, train_dqn, evaluate_dqn,
)
...
class Testbed:
    ...
    def run_tabular(self, env_factory, agent, n_episodes=10_000,
        ...
        rewards, eval_means, eval_stds, eval_eps = out
        final = evaluate_tabular(env_factory, agent, n_episodes=100)
    ...
    def run_dqn(self, env_factory, agent, n_steps=200_000,
        ...
        rewards, eval_means, eval_stds, eval_steps = out
